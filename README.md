- ~~:thought_balloon: :bulb: :balloon:~~ Former OIer & ACMer.
- :book: ScB (applied mathematics) & ScM (computational mathematics).
- :fountain_pen: Editor & Member of [OI-wiki](https://github.com/OI-wiki/).
- :mailbox_with_mail: `hi at tifa hyphen 233 dot com`.
